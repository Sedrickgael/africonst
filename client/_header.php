...
<head>
    ...
    <title>Afri-Const | Dashboard utilisateur</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="block m-t-xs font-bold"><?php echo $userinfo['prenoms'].' '.$userinfo['nom'] ?></span>
         ...
         ?>
                ...
                <li>
                    <a href="entreprises"><i class="fa fa-briefcase"></i><span class="nav-label">Entreprise </span><span class="fa arrow"></span></a>
                </li>
                <li>
                    <a href="contact""><i class="fa fa-edit"></i> <span class="nav-label">Contact</span><span class="fa arrow"></span></a>
                </li>
